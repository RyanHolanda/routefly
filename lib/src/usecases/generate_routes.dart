...
const errorMessages = (
  ...
  noMainFile:
      'No main file found😢. Please, add @Main in Widget that contain MaterialApp/CurpetinoApp',
);
...
class GenerateRoutes {
  ...
  Stream<ConsoleResponse> call(MainFileEntity mainFile) async* {
    ...
    for (var i = 0; i < files.length; i++) {
      try {
        entries.add(
          RouteRepresentation.withAppDir(
            appDir,
            _capitalize(mainFile.pageSuffix),
            files[i],
            i,
            mainFile.pageSuffix,
          ),
...
''';
  ...
  String _generateImports(
    List<RouteRepresentation> entries,
    String mainFilePath,
  ) {
